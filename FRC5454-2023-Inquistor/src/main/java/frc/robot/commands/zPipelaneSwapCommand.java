...
public zPipelaneSwapCommand(Limelight limelight,int gridChoice,boolean waitforPipepline){
  ...
  m_limeLight=limelight;
    ...
    public zPipelaneSwapCommand(Limelight limelight,int gridChoice){
      //constructor to support previous calls - assumes we will wait for pipeline to be swapped
      this(limelight,gridChoice,true);
    }
